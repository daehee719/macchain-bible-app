...
public class UserProgressResponse {
    ...
    private List<ReadingProgressResponse> readings;
    ...
    // 전체 생성자
    public UserProgressResponse(Long id, Long userId, LocalDate readingDate, int dayNumber,
                               List<ReadingProgressResponse> readings, int completedReadings, int totalReadings,
    ...
    public List<ReadingProgressResponse> getReadings() {
        return readings;
    }

    public void setReadings(List<ReadingProgressResponse> readings) {
        this.readings = readings;
    }
